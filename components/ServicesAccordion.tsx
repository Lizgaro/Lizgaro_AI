    ...
    <section className="px-4 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          ...
          description="Не набор модных слов, а рабочие связки под монетизацию: сайт, бот, контент, воронка, AI и органический трафик."
        />
          ...
          {services.map((service, index) => {
            ...
            return (
              <div key={service.title} className="border-b border-white/10 last:border-b-0">
                <button
                  type="button"
                  className="grid w-full gap-4 px-5 py-6 text-left transition hover:bg-white/[0.03] sm:grid-cols-[84px_1fr_32px] sm:px-8"
                ...
                {isActive ? (
                  <div className="grid gap-6 px-5 pb-7 sm:grid-cols-[84px_1fr] sm:px-8">
                    <div />
